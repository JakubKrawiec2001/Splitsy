...
const TotalRevenues = ({
  ...
  return (
    <div className="bg-white shadow-sm rounded-[5px] hidden md:flex items-center justify-between gap-4 p-6 2xl:px-8 2xl:py-2 col-start-3 col-end-5 row-start-1 row-end-2">
